...
namespace Backend.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Product",
                columns: new[] { "ProductId", "BrandId", "CategoryId", "CreatedAt", "Description", "DiscountPrice", "IsActive", "Price", "ProductName", "Stock", "UpdatedAt" },
                values: new object[] { -1, -1, -1, new DateTime(2025, 10, 8, 0, 0, 0, 0, DateTimeKind.Utc), "This is a sample description.", 149.99f, true, 199.99f, "Sample Product 1", 50, new DateTime(2025, 10, 8, 0, 0, 0, 0, DateTimeKind.Utc) });
